...
<head>
<meta charset="UTF-8">
<title>Tous les réservations</title>
<link rel="stylesheet"
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
					<div class="navbar-nav" style="margin-left: 600px;">
						  <a class="nav-link " style="margin-left: 25px;"
							href="${pageContext.request.contextPath}/reservationApprenant">Mes réservations</a> <a class="nav-link active"
							style="margin-left: 20px;"
							href="${pageContext.request.contextPath}/reservations">Réserver
							 </a>
						<button type="button"
				...
				<table class="table">
					...
					<c:forEach items="${listReservation}" var="r">
						<tr>
							...
							<td><a
								onclick="return confirm('êtes-vous sur de vouloir Annuler cette Réservation ?')"
								href="cancelReservation?id=${r.id}">Annuler</a></td>
						</tr>
